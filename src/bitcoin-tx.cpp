...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s sharecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  sharecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded sharecoin transaction") + "\n" +
              "  sharecoin-tx [options] -create [commands]   " + _("Create hex-encoded sharecoin transaction") + "\n" +
              "\n";
