...
{
    const char* pszTimestamp = "05/Jan/2018 Deadly Storm Eleanor batters Western Europe";
    const CScript genesisOutputScript = CScript() << ParseHex("044de99c985b3510a0b20e42fcf79f4ff70f2e7ade1353edbb580746f5b9cbf00e4b56c382a43252006f728bef8d2efab2528836aab30184d2cd2e01a7d57f3aaf") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1515140531, 855874, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();

		uint256 hash = uint256S("0xa257d79ea643ed5b5b2136b10eb61d71af8f48957bf719f854ae9312c1913bcd");

		if (true && genesis.GetHash() != hash)
        {
			printf("%s\n", hash.ToString().c_str());
		...
		*/
        ...
        checkpointData = (CCheckpointData) {
            {
                {  0, uint256S("0xa257d79ea643ed5b5b2136b10eb61d71af8f48957bf719f854ae9312c1913bcd")},
            }
        };
...
public:
    CTestNetParams() {
		...
		/*
        vSeeds.emplace_back("testnet-seed.sharecointools.com", true);
        vSeeds.emplace_back("seed-b.sharecoin.loshan.co.uk", true);
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1515140531, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();

		uint256 hash = uint256S("0x0e10b31d083dc1fa714ddd3443f6562ffd0d9ee240b47c59dbd72f299869d58c");
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x0e10b31d083dc1fa714ddd3443f6562ffd0d9ee240b47c59dbd72f299869d58c"));
        assert(genesis.hashMerkleRoot == uint256S("0x8015086200854d7c7aae8cafbf7c13ee5f7dcc05e27ae440d7480f281d2f8aef"));
        ...
        checkpointData = (CCheckpointData) {
            {
                {0, uint256S("0x0e10b31d083dc1fa714ddd3443f6562ffd0d9ee240b47c59dbd72f299869d58c")},
            }
        };
